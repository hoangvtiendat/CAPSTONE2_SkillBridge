...
public class CategoryProfessionController {
    ...
    @PostMapping("/Create")
    public ResponseEntity<ApiResponse> createCategoryProfession(
    ...
    @GetMapping("/{id}")
    Category GetCategoryProfession(
    ...
    public ResponseEntity<ApiResponse<Category>> updateCategoryProfession(
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(
                        200,
                        "Update tên lĩnh vữc thành công",
                        updated
                )
        );
    }
    ...
    public ResponseEntity<ApiResponse> deleteCategoryProfession(
            @PathVariable String id
    ) {
