...
public interface CompanyRepository extends JpaRepository<Company, String>, JpaSpecificationExecutor<Company> {
    ...
    @Query("""
        SELECT new com.skillbridge.backend.dto.response.CompanyFeedItemResponse(
            ...
            c.description, c.address, c.websiteUrl,u.email, u.phoneNumber, c.status, soc.subscriptionPlan.name,
            c.createdAt,
    ...
    @Query("""
        SELECT new com.skillbridge.backend.dto.response.CompanyFeedItemResponse(
            c.id, c.name, c.taxId, c.businessLicenseUrl, c.imageUrl,
            c.description, c.address, c.websiteUrl,u.email, u.phoneNumber, c.status, cs.subscriptionPlan.name,
